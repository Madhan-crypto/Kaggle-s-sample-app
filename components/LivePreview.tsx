      ...
      <div className="relative w-full flex-1 bg-[#09090b] flex overflow-hidden">
        {isLoading ? (
          ...
          <>
            ...
            {/* App Preview Panel - Spatial Edit */}
            <div className={`relative h-full transition-all duration-500 bg-[#09090b] ${showSplitView && creation.originalImage ? 'w-full md:w-1/2 h-1/2 md:h-full p-4 md:p-6' : 'w-full'}`}>
                 <div className={`w-full h-full bg-white shadow-2xl overflow-hidden ${showSplitView && creation.originalImage ? 'rounded-xl ring-1 ring-zinc-800' : ''}`}>
                     <iframe
